...
### A. Trilhas Investigativas — Como Pensar
...
## Conceitos obrigatórios a injetar
...
- **Omissão de relatórios SICONFI** — entidade que não envia RREO, RGF ou DCA dentro do prazo

---

## Exemplo de raciocínio auditorial

**Pergunta investigativa:** "Por que o governo empenhou o dinheiro em dezembro e só pagou em julho do ano seguinte?"

**Explicação mecânica:** Isso aciona o conceito de **Restos a Pagar**. O órgão corre para reservar a verba antes do fim do exercício fiscal para não perder o orçamento, empurrando o gargalo de execução e fiscalização para o ano seguinte — onde os controles são mais fracos.

---

## Conexão Trilha → Mapa

Ao final de cada passo 1 ou 2 de qualquer Trilha, inclua um gatilho de busca (🔍) apontando para o Mapa Técnico correspondente. Isso fecha o ciclo entre "como pensar" e "como fazer".
