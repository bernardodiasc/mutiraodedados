  ...
  return (
    <>
      <Section
        ...
        description="Tokens light/dark. Use sempre via classes Tailwind (bg-primary, text-foreground). Nunca cores diretas."
      >
      ...
      <Section
        ...
        description="Definidas globalmente em @layer base para links/role=button com borda e rounded."
      >
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="rounded-xl border border-border p-6 bg-card">
            Painel estático (sem sombra)
          </div>
          <a href="#" className="rounded-xl border border-border p-6 bg-card block">
            Card clicável (sombra padrão + lift)
          </a>
      ...
      <Section
        title="Espaçamento"
        description="Escala base do Tailwind (1 unidade = 0.25rem = 4px)."
      >
