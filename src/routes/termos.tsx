  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Termos de Uso — Mutirão de Dados" },
      {
        ...
        content: "Regras de uso, vedações e limites de responsabilidade.",
      },
    ],
  }),
});
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 prose-civic">
      ...
      <p className="mt-3 text-muted-foreground">
        O Mutirão de Dados é uma plataforma{" "}
        <strong className="text-foreground">experimental</strong> de pesquisa em transparência
        pública. Seu propósito é reorganizar, contextualizar e interpretar dados administrativos
        publicados por entes governamentais. Não substitui órgãos oficiais de controle (CGU, TCU,
        Ministério Público).
      </p>
      ...
      <p className="mt-3 text-muted-foreground">
        ...
        ). Anomalia estatística <strong className="text-foreground">não constitui</strong> indício
        jurídico, prova, parecer técnico ou conclusão sobre conduta. A plataforma não atribui
        responsabilidade a pessoas físicas ou jurídicas.
      </p>
      ...
      <ul className="mt-3 space-y-2 text-muted-foreground">
        ...
        <li>
          Indicar o Mutirão de Dados como fonte secundária e o portal oficial como fonte primária;
        </li>
      ...
      <p className="mt-3 text-muted-foreground">
        Comentários e marcações associadas ao perfil do usuário são{" "}
        <strong className="text-foreground">públicos</strong> e de responsabilidade exclusiva de
        quem os publica. A plataforma poderá remover conteúdo que viole estes termos ou a legislação
        vigente, sem prejuízo de cooperação com autoridades.
      </p>

      <h2 className="font-display text-2xl mt-10">5. Propriedade intelectual</h2>
      <p className="mt-3 text-muted-foreground">
        Os dados públicos reorganizados pertencem ao Estado brasileiro e são de livre acesso. A
        camada interpretativa, o código, o desenho e os textos editoriais da plataforma são de
        autoria do projeto e disponibilizados para uso não comercial com atribuição.
      </p>
      ...
      <p className="mt-3 text-muted-foreground">
        ...
        decisões tomadas com base exclusiva em seus indicadores. Dados públicos podem conter erros
        de origem; análises podem refletir essas limitações.
      </p>
