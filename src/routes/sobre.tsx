    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Observatório cívico de interpretação pública do Estado. Premissas, limites analíticos, fontes e responsabilidades editoriais.",
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 prose-civic">
      ...
      <p className="mt-6 text-lg text-muted-foreground">
        ...
        Trabalhamos com uma premissa: transparência não é a publicação de dados. É a possibilidade
        de interpretá-los.
      </p>

      <h2 className="font-display text-2xl mt-10">Premissa</h2>
      <p className="mt-3 text-muted-foreground">
        Dados administrativos isolados informam pouco. Um valor contratado, fora de série histórica
        e de comparação entre pares, é cifra sem sentido público. A camada faltante — e que
        tribunais de contas, imprensa e cidadãos têm pouco tempo de produzir cotidianamente — é a{" "}
        <strong className="text-foreground">camada interpretativa</strong>: contexto, agregação,
        comparação, narrativa metodológica.
      </p>
      <p className="mt-3 text-muted-foreground">
        Essa é a função da plataforma. Reorganizar dados públicos do Executivo federal, aplicar
        regras explicáveis para sinalizar padrões e devolver ao leitor um conjunto de leituras
        possíveis — sob responsabilidade declarada.
      </p>
      ...
      <ul className="mt-3 space-y-2 text-muted-foreground">
        ...
        <li>
          Documentamos integralmente nossa{" "}
      ...
      <ul className="mt-3 space-y-2 text-muted-foreground">
        ...
        <li>
          Não republicamos dados pessoais identificáveis — CPF, endereço, contatos pessoais — ainda
          que apareçam em documentos públicos. Ver{" "}
      ...
      <p className="mt-3 text-muted-foreground">
        Toda análise automatizada tem ponto cego. Regras estatísticas presumem regularidade — e o
        setor público brasileiro tem heterogeneidades estruturais que regras genéricas capturam mal.
        Mercados monopolistas legítimos, contratos plurianuais concentrados, emergências sanitárias
        e mudanças de política pública geram sinais que parecem anômalos sem serem irregulares.
      </p>
      <p className="mt-3 text-muted-foreground">
        Por isso a plataforma trabalha com vocabulário de <em>sinal investigativo</em>, não de{" "}
        <em>indício</em> ou <em>denúncia</em>. A diferença é jurídica e editorial — e está descrita
        na seção{" "}
      ...
      <p className="mt-3 text-muted-foreground">
        Contratos: API do Portal da Transparência (Controladoria-Geral da União). Catálogo de
        órgãos: SIORG. Cota parlamentar (CEAP/CEAPS), Judiciário (STF, STJ, CNJ) e Ministério
        Público têm APIs próprias e estão no roadmap — o catálogo já sinaliza esses órgãos como
        pendentes. Normalizações futuras por deflator e per capita usarão séries do IBGE e do IPEA.
        Toda análise preserva o vínculo com a fonte oficial.
      </p>

      <h2 className="font-display text-2xl mt-10">Estado de desenvolvimento</h2>
      <p className="mt-3 text-muted-foreground">
        A plataforma é <strong className="text-foreground">experimental</strong>. Funcionalidades
        estão em amadurecimento e a calibragem das regras será revisada conforme a amostra cresce.
        Apoios, críticas e contestações são bem-vindos — ver{" "}
      ...
      <p className="mt-3 text-muted-foreground">
        Este é um projeto aberto, sustentado por uso, revisão e contribuição voluntária. Se quiser
        ajudar — lendo dados, revisando sinais, marcando informações ou contribuindo com código —
        veja a página{" "}
