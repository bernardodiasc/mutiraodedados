...
export const SINAIS_CATALOGO: SinalCatalogo[] = [
  ...
  {
    slug: "votacao_listada_sem_detalhe",
    label: "Votação listada sem detalhe",
    tipo: "qualidade",
    fontes: ["camara_vot"],
    oQueDetecta:
      "A listagem de votações da Câmara traz a votação, mas o detalhe dela não existe na API. A votação fica fora da importação, e o alerta registra a inconsistência da origem.",
    limiares: "O detalhe (/votacoes/{id}) responde 404 para um id que a própria listagem devolveu.",
    severidade: "aviso",
    ondeRoda: "importação",
    persistencia: "banco",
    ativa: true,
