...
export const FONTES_LIMPEZA: FonteLimpeza[] = [
  ...
  { id: "camara_deputados", label: "Câmara — cadastro de deputados", descricao: "Cadastro completo da legislatura atual.", table: "camara_deputados_cache" },
  ...
  { id: "senado_senadores", label: "Senado — cadastro de senadores", descricao: "Cadastro completo.", table: "senado_senadores_cache" },
  ...
  {
    id: "transferegov_especiais",
    label: "Transferegov — Transferências Especiais (EC 105)",
    descricao: "Emendas com transferência direta (modalidade: especial).",
    table: "transferegov_emendas_cache",
    yearCol: "ano",
    extraEq: { col: "modalidade", value: "especial" },
    tentativaFonte: "transferegov_especiais",
  },
  {
    id: "transferegov_finalidade",
    label: "Transferegov — Finalidade Definida (EC 105)",
    descricao: "Emendas com finalidade definida pelo parlamentar (modalidade: finalidade_definida).",
    table: "transferegov_emendas_cache",
    yearCol: "ano",
    extraEq: { col: "modalidade", value: "finalidade_definida" },
    tentativaFonte: "transferegov_finalidade",
  },
  {
    id: "importacoes_log",
