...
export const ORGAOS_BASE: Orgao[] = [
  ...
  },
  {
    ...
    funcao: "Desenvolvimento Regional",
    poder: "executivo",
    disponivelPortal: true,
  },
  {
  ...
  // ===== Judiciário =====
  {
    ...
    poder: "judiciario",
    disponivelPortal: false,
    nota: "Portal de Transparência próprio do STF — integração planejada.",
  },
  {
    cod: "11000",
    sigla: "STJ",
    ...
    poder: "judiciario",
    disponivelPortal: false,
    nota: "Dados via CNJ/STJ — integração planejada.",
  },
  {
    cod: "12000",
    sigla: "JF",
  ...
  // ===== Ministério Público da União =====
  {
    ...
    funcao: "Essencial à Justiça",
    poder: "mpu",
    disponivelPortal: false,
    nota: "Inclui MPF, MPT, MPM e MPDFT — integração planejada.",
  },
];
 ...
 */
export const ORGAOS_OUTRAS_ESFERAS: Orgao[] = ORGAOS_BASE.filter((o) => o.poder !== "executivo");
