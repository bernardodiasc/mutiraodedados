...
|---|---|
| Escrever o conteúdo do mapa (passos, chaves de busca) | [`/docs/padroes/conteudo-investigativo.md`](/docs/padroes/conteudo-investigativo.md) e a skill `auditoria-cidada-conteudo-investigativo` |
...
- Só recorra a código/migração se precisar de **campo/tabela novos** — aí siga [`/docs/padroes/migrations.md`](/docs/padroes/migrations.md) (regra Lovable: sempre arquivo de migração novo com timestamp posterior) e registre a entrega pela skill `auditoria-cidada-features-roadmap`.
