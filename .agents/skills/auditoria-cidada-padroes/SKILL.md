---
name: auditoria-cidada-padroes
description: Padrões obrigatórios de desenvolvimento do Auditoria Cidadã (Container/View/logic, server functions, migrations, rotas, design tokens, pt-BR cidadão). Carregar ao criar/modificar componentes, server functions, migrations ou rotas.
---

# Padrões do projeto Auditoria Cidadã
